...
const imageClass = computed(() => {
  let classes =
    props.className + ' w-full wrapImg transition-all h-full duration-500 ';
...
<template>
  <div
    ...
    :style="{ height: props.height, zIndex: isLoading ? 10 : error ? 999 : 0 }"
  >
    <n-image
      :class="imageClass"
      :src="src"
      :style="{ opacity: isLoading ? 0 : 1, borderRadius: props.borderRadius }"
